...
// Function to handle scrolling and inject new "necks" based on scroll position
...
function injectWow() {
  ...
  // Add a new WOW text at a random position
...
// Start observing the initial neck element
